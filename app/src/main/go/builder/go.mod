...
require github.com/2dust/AndroidLibXrayLite v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/xtls/xray-core v1.260327.1-0.20260711155151-50231eaff98c // indirect
